...
function Dois_estagios(area, M, alpha, EAR, Unidade, Área_da_parcela, output_file, Conversor, N) #Determina a função
    ...
    XLSX.writetable(output_file, Dados=(collect(DataFrames.eachcol(output_file)), 
